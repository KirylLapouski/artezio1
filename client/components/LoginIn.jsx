            ...
            <div className="w-100 h-100 mask rgba-black-light d-flex justify-content-center align-items-center">
                ...
                <div className="container">
                    ...
                    <div className="row wow fadeIn" style={{ visibility: "visible", animationName: "fadeIn" }}>
                        ...
                        <form method="POST" name="loginIn" className="form-signin" onSubmit={this.onSubmitHandler} style={{ borderRadius: "5px", backgroundColor: "#fff", color: "#4f4f4f" }}>
                            ...
                            <button className="btn btn-lg btn-primary btn-block" type="submit">Sign in</button><br />
